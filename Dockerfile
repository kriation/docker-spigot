...
VOLUME /opt/spigot
ENTRYPOINT /usr/bin/java -Xms$MC_SERVER_MEM -XX:+UseG1GC -Dcom.mojang.eula.agree=$MC_EULA -jar /tmp/spigot-$SPIGOT_VERSION.jar --world-dir /opt/spigot/worlds --noconsole
